...
##### Data import #####
setwd("C:/Users/gabri/Desktop/Ubiqum/R/Deep_Analytics_and_Visualization/Task_1")
...
HHPC[c("Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3",
       "Global_reactive_power","Global_active_power")][is.na(HHPC[c("Voltage","Global_intensity",
                                                                    "Sub_metering_1","Sub_metering_2","Sub_metering_3",
                                                                    "Global_reactive_power","Global_active_power")])] <- 0
